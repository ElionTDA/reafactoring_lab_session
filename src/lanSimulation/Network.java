...
@return Anwer #true when the print operation was succesful and #false otherwise
				...
				if (document.message_.startsWith("!PS")) {
					...
					if (startPos >= 0) {
						...
						if (startPos >= 0) {
							...
							accounting(report, author, title, "Postscript");
				} else {
					title = "ASCII DOCUMENT";
					if (document.message_.length() >= 16) {
						author = document.message_.substring(8, 16);};
						accounting(report, author, title, "ASCII Print");
	 ...
	 * @throws IOException
	 */
	private void accounting(Writer report, String author, String title, String type) throws IOException {
